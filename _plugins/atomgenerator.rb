...
module Jekyll
  ...
  class AtomGenerator < Generator
    ...
    def generate(site)
      ...
      rss_path = ensure_slashes(site.config['atom_path'] || "/")
      rss_name = site.config['atom_name'] || "atom.xml"
      ...
      site.pages << Jekyll::AtomFeed.new(site, site.dest, rss_path, rss_name)
    end
